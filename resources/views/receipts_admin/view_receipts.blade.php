		  ...
		  <div class="row">
			<div class="col-12">
				...
				<div class="box-header with-border">
	                ...
	                <a href="{{ route('receipts_admin.receipt.add') }}" style="float: left; background-color: #609966; color:white" class="btn mb-5">أضافة وصل</a>
		...
		<tbody>
            ...
            <tr>
                ...
                <td style="display: flex;">
                    <a style="margin-left: 10px; background-color: #609966; color:white" href=" {{ route('receipts_admin.receipt.details', ['name' => $receipt->name]) }}" class=" btn ">عرض التفاصيل</a>
                    <a  style="margin-left: 10px;" class=" btn btn-secondary" href="{{ route('receipts_admin.receipt.edit', ['name' => $receipt->name]) }}">تعديل الوصل</a>
